...
## v15.1.3 Render Docker runtime

For cloud deployment of the frozen MuscleMap workflow, use the Docker configuration
under `inference_local/`. See `RENDER_DEPLOYMENT.md`. The frozen analysis files remain
unchanged; Docker provides their required Conda/runtime contract.
